...
```{r}
# Identify non-numeric values in phenodigm_score
problematic_scores <- data_frame %>%
  filter(!str_detect(phenodigm_score, "^\\d+(\\.\\d+)?$"))  # Matches valid numeric values

# View problematic rows
print("Problematic phenodigm_score rows:")
