...
write.csv(genes_param_wide, "/Users/sanjanasrinivasan/Desktop/DCDM_IMPC_Project/data/cleaned/genes_phenotype_scores.csv", row.names = FALSE)

# Read the reshaped matrix
genes_param_wide <- read.csv("/Users/sanjanasrinivasan/Desktop/DCDM_IMPC_Project/data/cleaned/genes_phenotype_scores.csv")
...
write.csv(pca_input, "/Users/sanjanasrinivasan/Desktop/DCDM_IMPC_Project/scripts/phenotype_dashboard/pca_input.csv", row.names = FALSE)
...
num_parameter_clusters <- 4  # choose how many param clusters you want
